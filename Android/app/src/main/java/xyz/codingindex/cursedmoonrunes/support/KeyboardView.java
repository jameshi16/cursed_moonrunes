package xyz.codingindex.cursedmoonrunes.support;

/*
* CodingIndex' note: copied from
* https://android.googlesource.com/platform/frameworks/base/+/master/core/java/android/inputmethodservice/KeyboardView.java
* as recommended by Google. Will probably replace with my own implementation just for fun later on.
*/
...
import xyz.codingindex.cursedmoonrunes.support.Keyboard.Key;
 ...
 *
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_keyBackground
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_keyPreviewLayout
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_keyPreviewOffset
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_keyPreviewHeight
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_labelTextSize
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_keyTextSize
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_keyTextColor
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_verticalCorrection
 * @attr ref xyz.codingindex.cursedmoonrunes.R.styleable#KeyboardView_popupLayout
 */
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_keyBackground:
                    mKeyBackground = a.getDrawable(attr);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_verticalCorrection:
                    mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_keyPreviewLayout:
                    previewLayout = a.getResourceId(attr, 0);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_keyPreviewOffset:
                    mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_keyPreviewHeight:
                    mPreviewHeight = a.getDimensionPixelSize(attr, 80);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_keyTextSize:
                    mKeyTextSize = a.getDimensionPixelSize(attr, 18);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_keyTextColor:
                    mKeyTextColor = a.getColor(attr, 0xFF000000);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_labelTextSize:
                    mLabelTextSize = a.getDimensionPixelSize(attr, 14);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_popupLayout:
                    mPopupLayout = a.getResourceId(attr, 0);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_shadowColor:
                    mShadowColor = a.getColor(attr, 0);
                    break;
                case xyz.codingindex.cursedmoonrunes.R.styleable.KeyboardView_shadowRadius:
        ...
        // Apparently com.android.internal.R.bool.config_swipeDisambiguation doens't exist in my emulator. Setting to false for now
